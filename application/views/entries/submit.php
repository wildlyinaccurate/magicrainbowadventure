<section class="submit-entry">
	<?=Form::open_for_files('entries/submit')?>

        <div class="control-group">
            <?=Form::text('title', Input::old('title'), array('maxlength' => 1400, 'placeholder' => Lang::line('entries.title')))?>
        ...
        <div class="control-group">
            ...
            <?=Form::label('entry_image', Lang::line('entries.upload_file'))?>
