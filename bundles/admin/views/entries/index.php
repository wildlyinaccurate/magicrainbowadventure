	...
	<table class="entries table table-condensed">
		...
		<tbody data-bind="foreach: entries">
			<tr data-bind="attr: { class: status }">
				...
				<td class="actions">
					<button class="btn btn-success" data-bind="visible: moderated_by() === null, click: setApprovedAndSave.bind($data, true)"><?=Lang::line('admin::entries.approve')?></button>
					<button class="btn btn-danger" data-bind="visible: moderated_by() === null, click: setApprovedAndSave.bind($data, false)"><?=Lang::line('admin::entries.decline')?></button>
